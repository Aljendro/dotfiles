...
(let [(telescope-ok? telescope) (pcall require "telescope")
      (telescope-actions-ok? telescope-actions) (pcall require "telescope.actions")]
  (when (and telescope-ok? telescope-actions-ok?)
    (telescope.setup
      {:defaults
       {:mappings
        {:i {"<C-j>" telescope-actions.move_selection_next
             "<C-k>" telescope-actions.move_selection_previous}
         :n {"<C-j>" telescope-actions.move_selection_next
             "<C-k>" telescope-actions.move_selection_previous}}
