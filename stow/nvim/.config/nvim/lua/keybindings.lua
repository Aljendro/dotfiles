...
c.kmap("n", "<M-s>", ":vertical resize +16<cr>")
c.kmap("n", "<M-f>", ":vertical resize -16<cr>")
...
c.kmap("n", "<leader>sr", "':wall | call v:lua.MakeSession(\"default\") | tabonly | call v:lua.LoadSession(\"' . nr2char(getchar()) . '\")<cr>'", {expr = true})
