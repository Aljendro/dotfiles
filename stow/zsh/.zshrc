...
export -U PATH="$DOTFILES_DIR/bin:$NVM_DIR/versions/node/v20.15.1/bin:$FZF_DIR/bin:$HOME/.yarn/bin:$HOME/.cargo/bin:/usr/local/go/bin:$PATH:$HOME/.local/bin"

export LANG=en_US.UTF-8
export EDITOR=nvim
export LOAD_ENV_INFO=0
export FZF_DEFAULT_OPTS="--preview-window 'right:70%:hidden:wrap' --bind ctrl-d:preview-half-page-down,ctrl-u:preview-half-page-up,tab:toggle-out,shift-tab:toggle-in,ctrl-p:toggle-preview"
